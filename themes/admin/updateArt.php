            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Editar arte</h3>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group m-form__group">
                                    ...
                                    <input value="<?= $art->name ?>" type="text" required class="form-control m-input"
                                           name="name"
                                ...
                                <div class="form-group m-form__group">
                                    ...
                                    <textarea class="form-control m-input" name="description"
                                              ...
                                              rows="3"><?= $art->description ?></textarea>
                                </div>
                                <div class="form-group m-form__group">
                                    <label><strong>Link do template</strong>*</label>
                                    <input value="<?= $art->link_template ?>" type="url" class="form-control m-input"
                                           name="link_template"
                                ...
                                <div class="form-group m-form__group">
                                    ...
                                    <select class="form-control m-input" name="id_pack">
                                        ...
                                        <?php if (!empty($packs)): foreach ($packs as $pack): ?>
                                            <option <?= $art->id_pack == $pack->id ? "selected" : "" ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <img lazy="loading" src="<?= image_glide($art->thumb, CONF_UPLOAD_IMAGE_DIR_ARTES, ['w' => 150, 'h' => 150, 'fit' => 'fill']) ?>" class="img-cover img-thumbnail"
                                        ...
                                        <?php if (!empty($categories)): foreach ($categories as $category): ?>
                                            <label class="checkbox">
                                                <input type="checkbox" value="<?= $category->id ?>"
                                                    <?= in_array($category->id, $categories_art) ? "checked" : "" ?>
                                                       name="categories[]"/>
                                                <span></span>
                                                <?= $category->name ?>
                                            </label>
