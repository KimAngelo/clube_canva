            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Editar tutorial</h3>
                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group m-form__group">
                                    ...
                                    <input type="text" class="form-control m-input" name="title"
                                        value="<?= $tutorial->title ?>"   placeholder="Digite o título do tutorial">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group m-form__group">
                                    ...
                                    <textarea class="form-control m-input" name="description"
                                              ...
                                              rows="3"><?= $tutorial->description ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group m-form__group">
                                    ...
                                    <select class="form-control m-input" name="status">
                                        <option <?= $tutorial->status == "post" ? "selected" : ""?> value="post">Ativo</option>
                                        <option <?= $tutorial->status == "draft" ? "selected" : ""?> value="draft">Rascunho</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <img src="<?= !empty($tutorial->cover) ? image($tutorial->cover, 320, 240, CONF_UPLOAD_IMAGE_DIR_BLOG) : "" ?>" class="img-cover img-thumbnail"
                            ...
                            <div class="col-md-12">
                                <div class="form-group m-form__group">
                                    ...
                                    <textarea class="form-control m-input" id="content" name="content"
                                              rows="10"><?= $tutorial->content ?></textarea>
                                </div>
                            </div>
